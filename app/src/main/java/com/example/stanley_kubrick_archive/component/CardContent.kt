...
fun CardContent(
    ...
    if (pagerPreviousPosition.value != pagerState.currentPage) {
        direction =
            if (pagerPreviousPosition.value > pagerState.currentPage) AnimatedContentScope.SlideDirection.Right else AnimatedContentScope.SlideDirection.Left
    }
                    ...
                    2 -> {
                        ...
                        Column {
                            Row(
                                ...
                                ActorCardItem(
                                    imageRes = item.listActors[0].image,
                                    modifier.weight(1f)
                                )
                                ActorCardItem(
